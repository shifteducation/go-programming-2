...
func (s UserService) UpdateAdrr(ctx context.Context, userId uuid.UUID, adr dto.UpdateAddressRequest) error {
	//UpdateAdrr(ctx context.Context, userId uuid.UUID, adrDto dto.UpdateAddressRequest) error
	return s.userRepository.UpdateAdrr(ctx, userId, adr)
}
